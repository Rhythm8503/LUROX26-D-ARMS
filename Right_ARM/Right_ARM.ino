...
{
  Serial.print("RIGHT ARM Communication Running...Core: ");
  ...
  for (;;)
  {
    ...
    if (spi_slave_rx_buf[0] == 0xA1) //Right_ARM
    {
      Serial.println("Right ARM Controller Selected!");
    ...
    {
      Serial.println("[RIGHT ARM]: No message for me!");
    }
  }
}
